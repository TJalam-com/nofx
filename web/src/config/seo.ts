...
export const defaultSEO: SEOConfig = {
  ...
  keywords:
    'AI trading, cryptocurrency, automated trading, crypto trading, AI models, trading platform',
...
export const seoConfig: Record<string, (lang: Language) => SEOConfig> = {
  ...
  '/login': (lang: Language) => ({
    title: lang === 'en' ? 'Login - AI Trading 24x7' : '登录 - AI Trading 24x7',
    description:
      lang === 'en'
  ...
  '/register': (lang: Language) => ({
    title:
      lang === 'en' ? 'Register - AI Trading 24x7' : '注册 - AI Trading 24x7',
    description:
      lang === 'en'
...
export function getArticleSEOConfig(
  article: {
    title: string
    metaTitle?: string
  ...
  const image =
    article.ogImageUrl || article.featuredImageUrl || DEFAULT_OG_IMAGE
