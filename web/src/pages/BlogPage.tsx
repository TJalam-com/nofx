...
export function BlogPage() {
  ...
  const {
    ...
    () => api.getPublishedArticles(articlesPerPage, (currentPage - 1) * articlesPerPage),
  ...
  const structuredData = {
    ...
    description: 'Latest articles about AI trading, cryptocurrency, and trading strategies',
    url: `${baseUrl}/blog`,
    mainEntity: {
      '@type': 'ItemList',
  ...
  return (
    <>
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4" style={{ color: 'var(--text-primary, #111827)' }}>
          Blog
        </h1>
        <p className="text-lg" style={{ color: 'var(--text-secondary, #6b7280)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {filteredArticles.map((article) => {
              ...
              >
                ...
                <div className="p-6">
                  <h2 className="text-xl font-semibold mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors" style={{ color: '#000000' }}>
                    {article.title}
                  </h2>
