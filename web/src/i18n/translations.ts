...
export const translations = {
  en: {
    ...
    aboutOpenSource1: 'AI Trading 24x7 is fully open source under the AGPL-3.0 license. This means you can view, modify, and distribute the source code, subject to the license terms.',
    ...
    contactGeneralSupportDesc: 'For general questions, feature requests, or platform usage help, please email contact@aitrading247.com.',
    contactBugReportTitle: 'Bug Reports',
    contactBugReportDesc: 'Found a bug? Please email contact@aitrading247.com with detailed steps to reproduce, expected behavior, and actual behavior. Include logs and screenshots if possible.',
    contactSecurityTitle: 'Security Issues',
    contactSecurityDesc: 'For security vulnerabilities, please email contact@aitrading247.com. Please do not publicly disclose vulnerabilities until we have had time to address them.',
  ...
  zh: {
    ...
    aboutOpenSource1: 'AI Trading 24x7在AGPL-3.0许可证下完全开源。这意味着您可以查看、修改和分发源代码，但需遵守许可证条款。',
    ...
    contactGeneralSupportDesc: '对于一般问题、功能请求或平台使用帮助，请发送邮件至contact@aitrading247.com。',
    contactBugReportTitle: '错误报告',
    contactBugReportDesc: '发现错误？请发送邮件至contact@aitrading247.com，提供详细的复现步骤、预期行为和实际行为。如果可能，请包含日志和截图。',
    contactSecurityTitle: '安全问题',
    contactSecurityDesc: '对于安全漏洞，请发送邮件至contact@aitrading247.com。在我们有时间修复之前，请不要公开披露漏洞。',
