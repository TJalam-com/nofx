  ...
  React.useEffect(() => {
    ...
    const handleError = (event: ErrorEvent) => {
      ...
      if (isReactRouterDOMError(error)) {
        ...
        console.warn(
          'React Router navigation warning (suppressed):',
          error?.message || error
        )
...
if (!rootElement) {
  ...
  document.body.innerHTML =
    '<div style="color: red; padding: 20px; font-family: monospace;">Error: Root element not found. Please check the console for details.</div>'
} else {
