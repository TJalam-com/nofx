...
// ResampleEquity resamples equity curve according to timeframe.
...
// LimitEquityPoints limits the number of data points within the given range (uniform sampling).
...
// LimitTradeEvents similarly samples trade events uniformly.
