...
// RestoreRunsFromDisk scans backtests directory and restores metadata for existing runs (service restart scenario).
...
// RestoreRunsFromDisk keeps old method name for backward compatibility.
