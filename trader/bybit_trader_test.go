...
// ============================================================
// Part 1: BybitTraderTestSuite - extends base test suite
// ============================================================

// BybitTraderTestSuite Bybit trader test suite
// Extends TraderTestSuite and adds Bybit-specific mock logic
type BybitTraderTestSuite struct {
	*TraderTestSuite // Embed base test suite
...
func NewBybitTraderTestSuite(t *testing.T) *BybitTraderTestSuite {
	// Create mock HTTP server (for validating response format)
...
// TestBybitTrader_InterfaceCompliance test interface compatibility
func TestBybitTrader_InterfaceCompliance(t *testing.T) {
	var _ Trader = (*BybitTrader)(nil)
}

// ============================================================
// Part 3: Bybit-specific unit tests
// ============================================================
...
func TestNewBybitTrader(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "Can create with empty API Key",
			apiKey:    "",
			secretKey: "test_secret_key",
			wantNil:   false,
		},
		{
			name:      "Can create with empty Secret Key",
			apiKey:    "test_api_key",
			secretKey: "",
			wantNil:   false,
		},
...
// checkBybitResponse check if Bybit API response has error
...
func TestBybitTrader_CacheDuration(t *testing.T) {
	...
	// Verify default cache duration is 15 seconds
